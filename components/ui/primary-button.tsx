...
const baseClasses =
  "inline-flex items-center justify-center gap-2 rounded-xl bg-copper-600 font-medium text-white shadow-card transition-colors hover:bg-copper-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-copper-600 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50";
