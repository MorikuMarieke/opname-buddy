...
export function CoordinatorDailyPlanningView() {
  const [planDate, setPlanDate] = useState(getAmsterdamDateString());
  const { data, isLoading, error } = useDailyParticipation(planDate);
    ...
    <div className="space-y-6">
      <DashboardCard density="compact">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-sm text-carbon-black-600">Dagplanning</p>
